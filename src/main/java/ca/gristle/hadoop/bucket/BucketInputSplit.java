...
public class BucketInputSplit extends FileSplit {
    ...
    public BucketInputSplit(FileSystem fs, String root, BucketSpec spec, JobConf job, FileSplit split) throws IOException {
    ...
    public String getBucketRelPath() {
        return _relPath;
    }
